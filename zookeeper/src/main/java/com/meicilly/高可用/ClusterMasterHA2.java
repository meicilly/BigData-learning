...
public class ClusterMasterHA2 {
     ...
     */
    private static final String HOSTNAME = "hadoop02";
    ...
    public static void main(String[] args) throws Exception {
        ...
        zk = new ZooKeeper(CONNECT_STRING, Session_TimeOut, new Watcher() {
            ...
            public void process(WatchedEvent event) {
                ...
                if (path.equals(ACTIVE) && type == Event.EventType.NodeChildrenChanged) {
                ...
                } else if (path.equals(LOCK) && type == Event.EventType.NodeCreated) {
